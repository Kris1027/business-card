    ...
    <article className="group overflow-hidden rounded-2xl bg-[var(--color-surface-card)] shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
      <div className="p-6 sm:p-8">
        ...
        <Link
          ...
          className="focus-glow mt-4 inline-flex items-center gap-2 rounded-md px-2 py-1 text-sm font-semibold text-[var(--color-text-link)] transition-all hover:gap-3 sm:mt-6 sm:text-base"
        >
          {t('services.readMore')}
