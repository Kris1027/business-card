      ...
      <section>
          ...
          {displayedTechnologies.map(tech => {
            ...
            return (
              <a
                ...
                className="group flex flex-col items-center gap-3 rounded-lg border border-[var(--color-border-default)] bg-[var(--color-surface-card)] p-6 shadow-md transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                <Icon
        ...
        {showAll && technologies.length > INITIAL_DISPLAY_COUNT && (
          <div className="mt-8 flex justify-center">
            <button
              onClick={toggleShowAll}
              className="inline-flex items-center gap-2 rounded-lg bg-[var(--color-interactive-primary)] px-6 py-3 font-semibold text-white shadow-md transition-all duration-300 hover:bg-[var(--color-interactive-primary-hover)] hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-focus-ring)] focus:ring-offset-2 active:scale-95"
              aria-expanded={showAll}
            >
              {t('about.showLess')}
